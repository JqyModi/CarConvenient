...
- (void)setManager:(HXPhotoManager *)manager {
    ...
    [self.previewBtn setTitleColor:[UIColor hex:@"#FD212E"] forState:UIControlStateNormal];
    [self.previewBtn setTitleColor:[UIColor hex:@"#FD212E"] forState:UIControlStateDisabled];
    self.doneBtn.backgroundColor = [self.manager.configuration.themeColor colorWithAlphaComponent:0.5];
    [self.originalBtn setTitleColor:[UIColor hex:@"#FD212E"] forState:UIControlStateNormal];
    [self.originalBtn setTitleColor:[UIColor hex:@"#FD212E"] forState:UIControlStateDisabled];
    ...
    [self.editBtn setTitleColor:[UIColor hex:@"#FD212E"] forState:UIControlStateNormal];
    [self.editBtn setTitleColor:[UIColor hex:@"#FD212E"] forState:UIControlStateDisabled];
    ...
    if (self.manager.configuration.selectedTitleColor) {
        [self.doneBtn setTitleColor:[UIColor hex:@"#FD212E"] forState:UIControlStateNormal];
        [self.doneBtn setTitleColor:[UIColor hex:@"#FD212E"] forState:UIControlStateDisabled];
    }
}
