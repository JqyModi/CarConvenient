...
- (UIButton *)rightBtn {
    if (!_rightBtn) {
        ...
        [_rightBtn setTitle:NSLocalizedString(@"确定", @"") forState:UIControlStateNormal];
...
//    [self.leftBtn setTitleColor:themeColor forState:UIControlStateNormal];
    [self.leftBtn setTitleColor:[UIColor hex:@"#333333"] forState:UIControlStateNormal];
    
//    self.rightBtn.backgroundColor = themeColor;
//    self.rightBtn.layer.cornerRadius = 6.0f;
//    self.rightBtn.layer.masksToBounds = YES;
//    [self.rightBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [self.rightBtn setTitleColor:[UIColor hex:@"#FD212E"] forState:UIControlStateNormal];
