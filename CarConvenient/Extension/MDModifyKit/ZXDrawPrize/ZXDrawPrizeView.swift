        ...
        if let dataSouce = dataSource {
            ...
            for n in 0..<zx_count {
                ...
                if tempI%2 == 0{
                    ...
                    color = UIColor(rgba: "#5FC2CA")
                }
                spl.setText(text: dataSouce.zxDrawPrize(prizeView: self, labelAt: tempI), textColor: color!)
            ...
            if let cbimage = dataSouce.zxDrawPrizeScrollBackgroundImage(prizeView: self) {
                ...
                for shape in zxShapeLayers {
                    ...
                    if index % 2 == 0 {
                        shape.zxshape.fillColor = UIColor(rgba: "#5FC2CA").cgColor
                    } else {
                        shape.zxshape.fillColor = UIColor.white.cgColor
                    }
                    index += 1
                }
            }
