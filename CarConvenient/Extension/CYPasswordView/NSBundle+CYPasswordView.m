...
+ (UIImage *)cy_textfieldImage {
    static UIImage *_image = nil;
    if (_image == nil) {
        _image = [[UIImage imageWithContentsOfFile:[[self cy_passwordViewBundle] pathForResource:@"passwordBg" ofType:@"png"]] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    }
    return _image;
}
