//
//  CCBillingDetailOutSideViewController.swift
//  CarConvenient
//
...
class CCBillingDetailOutSideViewController: BaseViewController {

    private lazy var viewControllers: [UIViewController] = {
        var vcs = [UIViewController]()
        vcs.append(CCBillingDetailViewController())
        vcs.append(CCBillingDetailViewController())
        return vcs
    }()
    ...
    private lazy var layout: LTLayout = {
        ...
        layout.titleFont = UIFont.systemFont(ofSize: 17)
        layout.titleColor = UIColor.init(rgba: "#1B82D2")
